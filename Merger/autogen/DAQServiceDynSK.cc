...
static const char* _0RL_enumMember_DAQCommand[] = { "CMD_CONFIGURE", "CMD_START", "CMD_STOP", "CMD_UNCONFIGURE", "CMD_PAUSE", "CMD_RESUME", "CMD_ERRORED", "CMD_RUNNINGBACK", "CMD_NOP" };
static CORBA::TypeCode_ptr _0RL_tc_DAQCommand = CORBA::TypeCode::PR_enum_tc("IDL:DAQCommand:1.0", "DAQCommand", _0RL_enumMember_DAQCommand, 9, &_0RL_tcTrack);
...
static const char* _0RL_enumMember_CompStatus[] = { "COMP_WORKING", "COMP_FINISHED", "COMP_WARNING", "COMP_FATAL", "COMP_ERRORED", "COMP_FIXWAIT" };
static CORBA::TypeCode_ptr _0RL_tc_CompStatus = CORBA::TypeCode::PR_enum_tc("IDL:CompStatus:1.0", "CompStatus", _0RL_enumMember_CompStatus, 6, &_0RL_tcTrack);
