...
enum HBMSG { ZERO, ONE /*, __max_HBMSG=0xffffffff */ };
typedef HBMSG& HBMSG_out;

_CORBA_GLOBAL_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_HBMSG;

enum HeartBeatDone { HBUNDONE, HBDONE /*, __max_HeartBeatDone=0xffffffff */ };
typedef HeartBeatDone& HeartBeatDone_out;

_CORBA_GLOBAL_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_HeartBeatDone;
...
_CORBA_GLOBAL_VAR _dyn_attr const ::CORBA::TypeCode_ptr _tc_TimeVal;
...
public:
  ...
  virtual RTC::ReturnCode_t setOperatorToComp() = 0;
  virtual HBMSG getOperatorToComp() = 0;
  virtual HeartBeatDone hb_checkDone() = 0;
  virtual void hb_setDone() = 0;
  virtual RTC::ReturnCode_t setTime(const ::TimeVal& now) = 0;
...
inline void operator >>=(HBMSG _e, cdrStream& s) {
  ::operator>>=((::CORBA::ULong)_e, s);
}
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, HBMSG& _s);

inline void operator >>=(HeartBeatDone _e, cdrStream& s) {
  ::operator>>=((::CORBA::ULong)_e, s);
}
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, HeartBeatDone& _s);

extern void operator<<=(::CORBA::Any& _a, const TimeVal& _s);
extern void operator<<=(::CORBA::Any& _a, TimeVal* _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, TimeVal*& _sp);
extern _CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const TimeVal*& _sp);
