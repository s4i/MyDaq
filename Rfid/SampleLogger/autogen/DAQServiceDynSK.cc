...
static const char* _0RL_enumMember_DAQLifeCycleState[] = { "LOADED", "CONFIGURED", "RUNNING", "PAUSED", "ERRORED" };
...
static const char* _0RL_enumMember_HBMSG[] = { "ZERO", "ONE" };
static CORBA::TypeCode_ptr _0RL_tc_HBMSG = CORBA::TypeCode::PR_enum_tc("IDL:HBMSG:1.0", "HBMSG", _0RL_enumMember_HBMSG, 2, &_0RL_tcTrack);
const CORBA::TypeCode_ptr _tc_HBMSG = _0RL_tc_HBMSG;

static const char* _0RL_enumMember_HeartBeatDone[] = { "HBUNDONE", "HBDONE" };
static CORBA::TypeCode_ptr _0RL_tc_HeartBeatDone = CORBA::TypeCode::PR_enum_tc("IDL:HeartBeatDone:1.0", "HeartBeatDone", _0RL_enumMember_HeartBeatDone, 2, &_0RL_tcTrack);
const CORBA::TypeCode_ptr _tc_HeartBeatDone = _0RL_tc_HeartBeatDone;

static CORBA::PR_structMember _0RL_structmember_TimeVal[] = {
  {"sec", CORBA::TypeCode::PR_long_tc()},
  {"usec", CORBA::TypeCode::PR_long_tc()}
};

#ifdef _0RL_tc_TimeVal
#  undef _0RL_tc_TimeVal
#endif
static CORBA::TypeCode_ptr _0RL_tc_TimeVal = CORBA::TypeCode::PR_struct_tc("IDL:TimeVal:1.0", "TimeVal", _0RL_structmember_TimeVal, 2, &_0RL_tcTrack);

const CORBA::TypeCode_ptr _tc_TimeVal = _0RL_tc_TimeVal;
...
static void _0RL_HBMSG_marshal_fn(cdrStream& _s, void* _v)
{
  HBMSG* _p = (HBMSG*)_v;
  *_p >>= _s;
}
static void _0RL_HBMSG_unmarshal_fn(cdrStream& _s, void*& _v)
{
  HBMSG* _p = (HBMSG*)_v;
  *_p <<= _s;
}

void operator<<=(::CORBA::Any& _a, HBMSG _s)
{
  _a.PR_insert(_0RL_tc_HBMSG,
               _0RL_HBMSG_marshal_fn,
               &_s);
}

::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, HBMSG& _s)
{
  return _a.PR_extract(_0RL_tc_HBMSG,
                       _0RL_HBMSG_unmarshal_fn,
                       &_s);
}

static void _0RL_HeartBeatDone_marshal_fn(cdrStream& _s, void* _v)
{
  HeartBeatDone* _p = (HeartBeatDone*)_v;
  *_p >>= _s;
}
static void _0RL_HeartBeatDone_unmarshal_fn(cdrStream& _s, void*& _v)
{
  HeartBeatDone* _p = (HeartBeatDone*)_v;
  *_p <<= _s;
}

void operator<<=(::CORBA::Any& _a, HeartBeatDone _s)
{
  _a.PR_insert(_0RL_tc_HeartBeatDone,
               _0RL_HeartBeatDone_marshal_fn,
               &_s);
}

::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, HeartBeatDone& _s)
{
  return _a.PR_extract(_0RL_tc_HeartBeatDone,
                       _0RL_HeartBeatDone_unmarshal_fn,
                       &_s);
}

static void _0RL_TimeVal_marshal_fn(cdrStream& _s, void* _v)
{
  TimeVal* _p = (TimeVal*)_v;
  *_p >>= _s;
}
static void _0RL_TimeVal_unmarshal_fn(cdrStream& _s, void*& _v)
{
  TimeVal* _p = new TimeVal;
  *_p <<= _s;
  _v = _p;
}
static void _0RL_TimeVal_destructor_fn(void* _v)
{
  TimeVal* _p = (TimeVal*)_v;
  delete _p;
}

void operator<<=(::CORBA::Any& _a, const TimeVal& _s)
{
  TimeVal* _p = new TimeVal(_s);
  _a.PR_insert(_0RL_tc_TimeVal,
               _0RL_TimeVal_marshal_fn,
               _0RL_TimeVal_destructor_fn,
               _p);
}
void operator<<=(::CORBA::Any& _a, TimeVal* _sp)
{
  _a.PR_insert(_0RL_tc_TimeVal,
               _0RL_TimeVal_marshal_fn,
               _0RL_TimeVal_destructor_fn,
...
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, TimeVal*& _sp)
{
  return _a >>= (const TimeVal*&) _sp;
}
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, const TimeVal*& _sp)
{
  void* _v;
  if (_a.PR_extract(_0RL_tc_TimeVal,
                    _0RL_TimeVal_unmarshal_fn,
                    _0RL_TimeVal_marshal_fn,
                    _0RL_TimeVal_destructor_fn,
                    _v)) {
    _sp = (const TimeVal*)_v;
    return 1;
  }
  return 0;
}
